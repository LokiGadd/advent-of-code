...
int main(){
    ...
    int q = 0;
    bool santaTurn = true;
    uSet.insert(to_string(x) + ", " + to_string(y));
    for(auto& a:input){
        if(santaTurn){
            if(a == '^'){
                y++;
            ...
            if(uSet.find(to_string(x) + ", " + to_string(y)) == uSet.end()){
                uSet.insert(to_string(x) + ", " + to_string(y));
            }
            santaTurn = false;
        } else {
            ...
            if(uSet.find(to_string(p) + ", " + to_string(q)) == uSet.end()){
                uSet.insert(to_string(p) + ", " + to_string(q));
            }
            santaTurn = true;
        }
    }
    cout << "number of houses visited: " << uSet.size() << endl;
    return 0;
}